...
class TaskFile(models.Model):
    #task
#    creator = models.ForeignKey(TaskFileEvent)
    #role: in or out
...
#    tasks = models.ManyToManyField(Task, verbose_name="list of tasks")
    ...
    # local files
    inputfiles = models.ManyToManyField(TaskFile, related_name="inputto",verbose_name="list of input files")
    localfiles = models.ManyToManyField(TaskFile, related_name="localto", verbose_name="list of local files")
    outputfiles = models.ManyToManyField(TaskFile, related_name="outputfrom", verbose_name="list of output files")
